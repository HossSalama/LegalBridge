...
namespace smartLaywer.Services.ClassService
{
    public class DocumentService : IDocumentService
    {
        ...
        {
            var docs = await _unitOfWork.Document.GetAllAsync();
        ...
        public async Task<string> UploadDocumentAsync(UploadDocumentDto dto)
        {
            ...
            var caseId = (await _unitOfWork.Cases.GetAllAsync()).FirstOrDefault()?.Id;
            var userId = (await _unitOfWork.Users.GetAllAsync()).FirstOrDefault()?.Id;
            ...
            await _unitOfWork.Document.AddAsync(doc);
            await _unitOfWork.CompleteAsync();
